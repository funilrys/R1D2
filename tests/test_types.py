...
class TestRestaurant(unittest.TestCase):
    ...
    def test_from_string(self):
        self.assertEqual(
            types.Restaurant.r1, types.restaurant_from_string("r1")
        )
        self.assertEqual(
            types.Restaurant.r2, types.restaurant_from_string("r2")
        )
        self.assertEqual(
            types.Restaurant.r3, types.restaurant_from_string("r3")
        )
